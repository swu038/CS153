...
ls(char *path)
{
 ...
 2de:	e8 fd 02 00 00       	call   5e0 <read>
...
gets(char *buf, int max)
{
 ...
 48e:	e8 4d 01 00 00       	call   5e0 <read>
...
stat(char *n, struct stat *st)
{
 ...
 4ec:	e8 17 01 00 00       	call   608 <open>
...
morecore(uint nu)
{
 ...
 9f6:	e8 55 fc ff ff       	call   650 <sbrk>
