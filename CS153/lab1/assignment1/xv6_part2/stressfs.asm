...
main(int argc, char *argv[])
{
  ...
  d3:	e8 94 03 00 00       	call   46c <open>
...
//    printf(fd, "%d\n", i);
 ...
 106:	e8 41 03 00 00       	call   44c <write>
...
//    printf(fd, "%d\n", i);
 ...
 127:	e8 28 03 00 00       	call   454 <close>
 ...
 152:	e8 15 03 00 00       	call   46c <open>
 ...
 185:	e8 ba 02 00 00       	call   444 <read>
  close(fd);
 ...
 1a6:	e8 a9 02 00 00       	call   454 <close>

  wait();
 1ab:	e8 84 02 00 00       	call   434 <wait>
...
gets(char *buf, int max)
{
 ...
 2f2:	e8 4d 01 00 00       	call   444 <read>
...
stat(char *n, struct stat *st)
{
 ...
 350:	e8 17 01 00 00       	call   46c <open>
...
putc(int fd, char c)
{
 ...
 4f5:	e8 52 ff ff ff       	call   44c <write>
}
 4fa:	c9                   	leave  
 4fb:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 85a:	e8 55 fc ff ff       	call   4b4 <sbrk>
