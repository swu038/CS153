...
printf(int fd, char *s, ...)
{
  ...
  22:	e8 81 03 00 00       	call   3a8 <write>
}
  27:	c9                   	leave  
  28:	c3                   	ret    
  ...
  60:	e8 13 03 00 00       	call   378 <exit>
{
  ...
  for(; n > 0; n--){
    if(wait() < 0){
  9f:	e8 ec 02 00 00       	call   390 <wait>
  ...
  if(wait() != -1){
  cb:	e8 c0 02 00 00       	call   390 <wait>
...
gets(char *buf, int max)
{
 ...
 24e:	e8 4d 01 00 00       	call   3a0 <read>
...
stat(char *n, struct stat *st)
{
 ...
 2ac:	e8 17 01 00 00       	call   3c8 <open>
