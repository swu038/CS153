...
main(void)
{
  ...
  bf:	e8 00 03 00 00       	call   3c4 <exec>
      printf(1, "init: exec sh failed\n");
  ...
  f1:	eb 01                	jmp    f4 <main+0xf4>
    ...
    while((wpid=wait()) >= 0 && wpid != pid)
  f3:	90                   	nop
  f4:	e8 9b 02 00 00       	call   394 <wait>
...
gets(char *buf, int max)
{
 ...
 252:	e8 4d 01 00 00       	call   3a4 <read>
...
stat(char *n, struct stat *st)
{
 ...
 2b0:	e8 17 01 00 00       	call   3cc <open>
...
putc(int fd, char c)
{
 ...
 455:	e8 52 ff ff ff       	call   3ac <write>
}
 45a:	c9                   	leave  
 45b:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7ba:	e8 55 fc ff ff       	call   414 <sbrk>
