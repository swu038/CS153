...
main(int argc, char *argv[])
{
  ...
  41:	e8 1a 03 00 00       	call   360 <mkdir>
  ...
  5a:	c7 44 24 04 56 08 00 	movl   $0x856,0x4(%esp)
  61:	00 
...
gets(char *buf, int max)
{
 ...
 1be:	e8 4d 01 00 00       	call   310 <read>
...
stat(char *n, struct stat *st)
{
 ...
 21c:	e8 17 01 00 00       	call   338 <open>
 ...
 23e:	e8 0d 01 00 00       	call   350 <fstat>
 243:	89 45 f4             	mov    %eax,-0xc(%ebp)
  close(fd);
 246:	8b 45 f0             	mov    -0x10(%ebp),%eax
 249:	89 04 24             	mov    %eax,(%esp)
 24c:	e8 cf 00 00 00       	call   320 <close>
  return r;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 412:	0f b6 80 7c 08 00 00 	movzbl 0x87c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 570:	75 27                	jne    599 <printf+0x120>
          s = "(null)";
 572:	c7 45 e4 72 08 00 00 	movl   $0x872,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 63f:	a1 98 08 00 00       	mov    0x898,%eax
...
free(void *ap)
{
 ...
 700:	a3 98 08 00 00       	mov    %eax,0x898
}
 705:	c9                   	leave  
 706:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 726:	e8 55 fc ff ff       	call   380 <sbrk>
 ...
 753:	e8 d8 fe ff ff       	call   630 <free>
  return freep;
 758:	a1 98 08 00 00       	mov    0x898,%eax
}
 75d:	c9                   	leave  
 75e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 771:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 774:	a1 98 08 00 00       	mov    0x898,%eax
 779:	89 45 f0             	mov    %eax,-0x10(%ebp)
 77c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 780:	75 23                	jne    7a5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 782:	c7 45 f0 90 08 00 00 	movl   $0x890,-0x10(%ebp)
 789:	8b 45 f0             	mov    -0x10(%ebp),%eax
 78c:	a3 98 08 00 00       	mov    %eax,0x898
 791:	a1 98 08 00 00       	mov    0x898,%eax
 796:	a3 90 08 00 00       	mov    %eax,0x890
    base.s.size = 0;
 79b:	c7 05 94 08 00 00 00 	movl   $0x0,0x894
 7a2:	00 00 00 
  }
 ...
 7f8:	a3 98 08 00 00       	mov    %eax,0x898
      return (void*)(p + 1);
 ...
 803:	eb 38                	jmp    83d <malloc+0xde>
    ...
    if(p == freep)
 805:	a1 98 08 00 00       	mov    0x898,%eax
