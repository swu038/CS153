...
int main(){
   ...
   6:	83 ec 30             	sub    $0x30,%esp
    int i;
    int begin = getpid();
   9:	e8 66 04 00 00       	call   474 <getpid>
...
int main(){
  ...
  83:	00 
            if(getpid() == begin+8){
  84:	e8 eb 03 00 00       	call   474 <getpid>
  ...
  94:	e8 db 03 00 00       	call   474 <getpid>
  ...
  b8:	e8 d7 03 00 00       	call   494 <setPriority>
            }
            while(j++ < 30000000);
  ...
  d8:	e8 0f 03 00 00       	call   3ec <exit1>
        }
    }else if(pid == 0){
 ...
 107:	e8 e0 02 00 00       	call   3ec <exit1>
    }
    int ki = 1;
 ...
 11d:	e8 d2 02 00 00       	call   3f4 <wait1>
 ...
 17b:	e8 6c 02 00 00       	call   3ec <exit1>
...
00000295 <gets>:
 ...
 2ba:	e8 4d 01 00 00       	call   40c <read>
...
00000304 <stat>:
 ...
 318:	e8 17 01 00 00       	call   434 <open>
...
00000803 <morecore>:
 ...
 822:	e8 55 fc ff ff       	call   47c <sbrk>
