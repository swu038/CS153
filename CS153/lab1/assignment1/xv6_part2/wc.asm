...
wc(int fd, char *name)
{
  ...
  52:	c7 04 24 7f 09 00 00 	movl   $0x97f,(%esp)
  ...
  9e:	e8 ad 03 00 00       	call   450 <read>
  ...
  b6:	c7 44 24 04 85 09 00 	movl   $0x985,0x4(%esp)
  bd:	00 
  be:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  c5:	e8 ef 04 00 00       	call   5b9 <printf>
    exit();
  ...
  eb:	c7 44 24 04 95 09 00 	movl   $0x995,0x4(%esp)
  f2:	00 
  f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  fa:	e8 ba 04 00 00       	call   5b9 <printf>
}
  ff:	c9                   	leave  
 100:	c3                   	ret    
...
main(int argc, char *argv[])
{
 ...
 10e:	7f 19                	jg     129 <main+0x28>
    wc(0, "");
 110:	c7 44 24 04 a2 09 00 	movl   $0x9a2,0x4(%esp)
 117:	00 
 ...
 14a:	e8 29 03 00 00       	call   478 <open>
 ...
 16a:	c7 44 24 04 a3 09 00 	movl   $0x9a3,0x4(%esp)
 171:	00 
 172:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 179:	e8 3b 04 00 00       	call   5b9 <printf>
      exit();
 ...
 1a6:	e8 b5 02 00 00       	call   460 <close>
  if(argc <= 1){
    wc(0, "");
    exit();
  }
...
gets(char *buf, int max)
{
 ...
 2fe:	e8 4d 01 00 00       	call   450 <read>
...
stat(char *n, struct stat *st)
{
 ...
 35c:	e8 17 01 00 00       	call   478 <open>
 ...
 37e:	e8 0d 01 00 00       	call   490 <fstat>
...
putc(int fd, char c)
{
 ...
 501:	e8 52 ff ff ff       	call   458 <write>
}
 506:	c9                   	leave  
 507:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 552:	0f b6 80 c0 09 00 00 	movzbl 0x9c0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 6b0:	75 27                	jne    6d9 <printf+0x120>
          s = "(null)";
 6b2:	c7 45 e4 b7 09 00 00 	movl   $0x9b7,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 77f:	a1 e8 09 00 00       	mov    0x9e8,%eax
...
free(void *ap)
{
 ...
 840:	a3 e8 09 00 00       	mov    %eax,0x9e8
}
 845:	c9                   	leave  
 846:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 866:	e8 55 fc ff ff       	call   4c0 <sbrk>
 ...
 893:	e8 d8 fe ff ff       	call   770 <free>
  return freep;
 898:	a1 e8 09 00 00       	mov    0x9e8,%eax
}
 89d:	c9                   	leave  
 89e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8b1:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 8b4:	a1 e8 09 00 00       	mov    0x9e8,%eax
 8b9:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8bc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8c0:	75 23                	jne    8e5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8c2:	c7 45 f0 e0 09 00 00 	movl   $0x9e0,-0x10(%ebp)
 8c9:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8cc:	a3 e8 09 00 00       	mov    %eax,0x9e8
 8d1:	a1 e8 09 00 00       	mov    0x9e8,%eax
 8d6:	a3 e0 09 00 00       	mov    %eax,0x9e0
    base.s.size = 0;
 8db:	c7 05 e4 09 00 00 00 	movl   $0x0,0x9e4
 8e2:	00 00 00 
  }
 ...
 938:	a3 e8 09 00 00       	mov    %eax,0x9e8
      return (void*)(p + 1);
 ...
 943:	eb 38                	jmp    97d <malloc+0xde>
    ...
    if(p == freep)
 945:	a1 e8 09 00 00       	mov    0x9e8,%eax
