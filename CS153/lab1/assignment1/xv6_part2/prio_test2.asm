...
_prio_test2:     file format elf32-i386
...
int main(){
   ...
   6:	83 ec 30             	sub    $0x30,%esp
    int i;
    int begin = getpid();
   9:	e8 d2 04 00 00       	call   4e0 <getpid>
...
int main(){
  ...
  83:	00 
            if(getpid() == begin + 5){
  84:	e8 57 04 00 00       	call   4e0 <getpid>
  ...
  94:	e8 47 04 00 00       	call   4e0 <getpid>
  ...
  b8:	e8 43 04 00 00       	call   500 <setPriority>
            }
            if(getpid() == begin + 8){
  bd:	e8 1e 04 00 00       	call   4e0 <getpid>
  c2:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  c6:	83 c2 08             	add    $0x8,%edx
  c9:	39 d0                	cmp    %edx,%eax
  cb:	75 29                	jne    f6 <main+0xf6>
                printf(1," pid = %d, get higher priority\n\n",getpid());
  cd:	e8 0e 04 00 00       	call   4e0 <getpid>
  ...
  f1:	e8 0a 04 00 00       	call   500 <setPriority>
            }
            while(j++ < 30000000);
 ...
 111:	e8 42 03 00 00       	call   458 <exit1>
        }
    }else if(pid == 0){
 ...
 140:	e8 13 03 00 00       	call   458 <exit1>
    }
    int ki = 1;
 ...
 159:	e8 02 03 00 00       	call   460 <wait1>
 ...
 1e6:	e8 6d 02 00 00       	call   458 <exit1>
 1eb:	90                   	nop
...
00000301 <gets>:
 ...
 326:	e8 4d 01 00 00       	call   478 <read>
...
00000370 <stat>:
 ...
 384:	e8 17 01 00 00       	call   4a0 <open>
...
00000508 <putc>:
 ...
 529:	e8 52 ff ff ff       	call   480 <write>
 52e:	c9                   	leave  
 52f:	c3                   	ret    
...
0000086f <morecore>:
 ...
 88e:	e8 55 fc ff ff       	call   4e8 <sbrk>
