...
gets(char *buf, int max)
{
 ...
 24a:	e8 4d 01 00 00       	call   39c <read>
...
stat(char *n, struct stat *st)
{
 ...
 2a8:	e8 17 01 00 00       	call   3c4 <open>
...
morecore(uint nu)
{
 ...
 7b2:	e8 55 fc ff ff       	call   40c <sbrk>
