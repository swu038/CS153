...
main(int argc, char **argv)
{
  ...
  49:	e8 b2 02 00 00       	call   300 <kill>
...
gets(char *buf, int max)
{
 ...
 19e:	e8 45 01 00 00       	call   2e8 <read>
...
stat(char *n, struct stat *st)
{
 ...
 1fc:	e8 0f 01 00 00       	call   310 <open>
...
morecore(uint nu)
{
 ...
 706:	e8 4d fc ff ff       	call   358 <sbrk>
