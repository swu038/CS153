...
gets(char *buf, int max)
{
 ...
 15e:	e8 45 01 00 00       	call   2a8 <read>
...
stat(char *n, struct stat *st)
{
 ...
 1bc:	e8 0f 01 00 00       	call   2d0 <open>
...
morecore(uint nu)
{
 ...
 6c6:	e8 4d fc ff ff       	call   318 <sbrk>
