...
main(int argc, char *argv[])
{
  ...
  3f:	e8 04 03 00 00       	call   348 <link>
...
gets(char *buf, int max)
{
 ...
 1b6:	e8 45 01 00 00       	call   300 <read>
...
stat(char *n, struct stat *st)
{
 ...
 214:	e8 0f 01 00 00       	call   328 <open>
