...
opentest(void)
{
  ...
  fd = open("echo", 0);
      ...
      2a:	e8 35 3c 00 00       	call   3c64 <open>
...
writetest(void)
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
      ...
      d5:	e8 8a 3b 00 00       	call   3c64 <open>
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     134:	e8 0b 3b 00 00       	call   3c44 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     175:	e8 ca 3a 00 00       	call   3c44 <write>
  ...
  i = read(fd, buf, 2000);
     ...
     216:	e8 21 3a 00 00       	call   3c3c <read>
  ...
  close(fd);
     ...
     25e:	e8 e9 39 00 00       	call   3c4c <close>

  if(unlink("small") < 0){
     263:	c7 04 24 f2 41 00 00 	movl   $0x41f2,(%esp)
     26a:	e8 05 3a 00 00       	call   3c74 <unlink>
...
writetest1(void)
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     2ea:	e8 75 39 00 00       	call   3c64 <open>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     33b:	e8 04 39 00 00       	call   3c44 <write>
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     3d5:	e8 62 38 00 00       	call   3c3c <read>
  ...
  close(fd);
     ...
     483:	e8 c4 37 00 00       	call   3c4c <close>
  if(unlink("big") < 0){
     488:	c7 04 24 28 43 00 00 	movl   $0x4328,(%esp)
     48f:	e8 e0 37 00 00       	call   3c74 <unlink>
...
createtest(void)
{
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     55b:	e8 14 37 00 00       	call   3c74 <unlink>
    fd = open(name, O_CREATE|O_RDWR);
    close(fd);
  }
  name[0] = 'a';
...
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0){
     ...
     5a3:	e8 e4 36 00 00       	call   3c8c <mkdir>
  ...
  if(chdir("dir0") < 0){
     ...
     5cd:	e8 c2 36 00 00       	call   3c94 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     5f7:	e8 98 36 00 00       	call   3c94 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     621:	e8 4e 36 00 00       	call   3c74 <unlink>
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
     ...
     685:	e8 d2 35 00 00       	call   3c5c <exec>
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
     ...
     6b6:	e8 79 35 00 00       	call   3c34 <pipe>
  ...
  if(pid == 0){
    ...
    close(fds[0]);
     ...
     6f7:	e8 50 35 00 00       	call   3c4c <close>
    for(n = 0; n < 5; n++){
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     741:	e8 fe 34 00 00       	call   3c44 <write>
  ...
  if(pid == 0){
    ...
    close(fds[1]);
     ...
     785:	e8 c2 34 00 00       	call   3c4c <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     819:	e8 1e 34 00 00       	call   3c3c <read>
    ...
    close(fds[0]);
     ...
     85a:	e8 ed 33 00 00       	call   3c4c <close>
    wait();
     85f:	e8 c8 33 00 00       	call   3c2c <wait>
  } else {
...
preempt(void)
{
  ...
  pipe(pfds);
     ...
     8d5:	e8 5a 33 00 00       	call   3c34 <pipe>
  pid3 = fork();
  ...
  if(pid3 == 0){
    ...
    close(pfds[0]);
     ...
     8ee:	e8 59 33 00 00       	call   3c4c <close>
    if(write(pfds[1], "x", 1) != 1)
     ...
     909:	e8 36 33 00 00       	call   3c44 <write>
    ...
    close(pfds[1]);
     ...
     92d:	e8 1a 33 00 00       	call   3c4c <close>
    for(;;)
      ;
  ...
  close(pfds[1]);
     ...
     93a:	e8 0d 33 00 00       	call   3c4c <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     955:	e8 e2 32 00 00       	call   3c3c <read>
  ...
  close(pfds[0]);
     ...
     97b:	e8 cc 32 00 00       	call   3c4c <close>
  printf(1, "kill... ");
  ...
  wait();
     9c9:	e8 5e 32 00 00       	call   3c2c <wait>
  wait();
     9ce:	e8 59 32 00 00       	call   3c2c <wait>
  wait();
     9d3:	e8 54 32 00 00       	call   3c2c <wait>
  printf(1, "preempt ok\n");
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid){
     ...
     a25:	74 20                	je     a47 <exitwait+0x59>
      if(wait() != pid){
     a27:	e8 00 32 00 00       	call   3c2c <wait>
...
mem(void)
{
  ...
  ppid = getpid();
     a86:	e8 19 32 00 00       	call   3ca4 <getpid>
  ...
  if((pid = fork()) == 0){
    ...
    if(m1 == 0){
     ...
     b1c:	e8 33 31 00 00       	call   3c54 <kill>
      exit();
    ...
    wait();
     b4a:	e8 dd 30 00 00       	call   3c2c <wait>
  }
}
     b4f:	c9                   	leave  
     b50:	c3                   	ret    
...
sharedfd(void)
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     bfc:	e8 43 30 00 00       	call   3c44 <write>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     cd3:	e8 64 2f 00 00       	call   3c3c <read>
  ...
  close(fd);
     ...
     ce7:	e8 60 2f 00 00       	call   3c4c <close>
  unlink("sharedfd");
     cec:	c7 04 24 c6 45 00 00 	movl   $0x45c6,(%esp)
     cf3:	e8 7c 2f 00 00       	call   3c74 <unlink>
...
twofiles(void)
{
  ...
  unlink("f1");
     ...
     d6b:	e8 04 2f 00 00       	call   3c74 <unlink>
  unlink("f2");
     d70:	c7 04 24 7b 46 00 00 	movl   $0x467b,(%esp)
     d77:	e8 f8 2e 00 00       	call   3c74 <unlink>
  ...
  fd = open(fname, O_CREATE | O_RDWR);
     ...
     dc6:	e8 99 2e 00 00       	call   3c64 <open>
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e36:	e8 09 2e 00 00       	call   3c44 <write>
  ...
  close(fd);
     ...
     e77:	e8 d0 2d 00 00       	call   3c4c <close>
  if(pid)
     e7c:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
     e80:	74 11                	je     e93 <twofiles+0x149>
    wait();
     e82:	e8 a5 2d 00 00       	call   3c2c <wait>
  else
    exit();
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     eb5:	e8 aa 2d 00 00       	call   3c64 <open>
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f33:	e8 04 2d 00 00       	call   3c3c <read>
    ...
    close(fd);
     ...
     f47:	e8 00 2d 00 00       	call   3c4c <close>
    if(total != 12*500){
  ...
  unlink("f1");
     ...
     f8a:	e8 e5 2c 00 00       	call   3c74 <unlink>
  unlink("f2");
     f8f:	c7 04 24 7b 46 00 00 	movl   $0x467b,(%esp)
     f96:	e8 d9 2c 00 00       	call   3c74 <unlink>
...
createdelete(void)
{
  ...
  for(i = 0; i < N; i++){
    ...
    102e:	e8 31 2c 00 00       	call   3c64 <open>
    ...
    105b:	e8 ec 2b 00 00       	call   3c4c <close>
    if(i > 0 && (i % 2 ) == 0){
    ...
    1089:	e8 e6 2b 00 00       	call   3c74 <unlink>
  ...
  if(pid==0)
    ...
    wait();
    10c4:	e8 63 2b 00 00       	call   3c2c <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    10f0:	e8 6f 2b 00 00       	call   3c64 <open>
    ...
    1168:	e8 df 2a 00 00       	call   3c4c <close>
    ...
    1188:	e8 d7 2a 00 00       	call   3c64 <open>
    ...
    1200:	e8 47 2a 00 00       	call   3c4c <close>
  if(pid==0)
    exit();
  else
    wait();
...
unlinkread(void)
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    128c:	e8 d3 29 00 00       	call   3c64 <open>
  ...
  if(unlink("unlinkread") != 0){
    ...
    1316:	e8 59 29 00 00       	call   3c74 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1347:	e8 18 29 00 00       	call   3c64 <open>
  ...
  write(fd1, "yyy", 3);
    ...
    1365:	e8 da 28 00 00       	call   3c44 <write>
  close(fd1);
    136a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    136d:	89 04 24             	mov    %eax,(%esp)
    1370:	e8 d7 28 00 00       	call   3c4c <close>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    138b:	e8 ac 28 00 00       	call   3c3c <read>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13e8:	e8 57 28 00 00       	call   3c44 <write>
  ...
  close(fd);
    ...
    1411:	e8 36 28 00 00       	call   3c4c <close>
  unlink("unlinkread");
    1416:	c7 04 24 52 47 00 00 	movl   $0x4752,(%esp)
    141d:	e8 52 28 00 00       	call   3c74 <unlink>
...
linktest(void)
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14b6:	e8 89 27 00 00       	call   3c44 <write>
  ...
  fd = open("lf2", 0);
    ...
    1561:	e8 fe 26 00 00       	call   3c64 <open>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    159e:	e8 99 26 00 00       	call   3c3c <read>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1649:	e8 36 26 00 00       	call   3c84 <link>
...
concreate(void)
{
  ...
  for(i = 0; i < 40; i++){
    ...
    16be:	e8 b1 25 00 00       	call   3c74 <unlink>
    pid = fork();
    ...
    1701:	e8 7e 25 00 00       	call   3c84 <link>
  file[2] = '\0';
  for(i = 0; i < 40; i++){
    file[1] = '0' + i;
    unlink(file);
    ...
    1744:	e8 3b 25 00 00       	call   3c84 <link>
    file[1] = '0' + i;
    unlink(file);
    pid = fork();
    if(pid && (i % 3) == 1){
    ...
    1759:	e8 06 25 00 00       	call   3c64 <open>
    ...
    178d:	e8 ba 24 00 00       	call   3c4c <close>
    }
    if(pid == 0)
    ...
    1798:	e8 7f 24 00 00       	call   3c1c <exit>
      ...
      wait();
    179d:	e8 8a 24 00 00       	call   3c2c <wait>
  } de;
  ...
  fd = open(".", 0);
    ...
    17da:	e8 85 24 00 00       	call   3c64 <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    18a0:	e8 97 23 00 00       	call   3c3c <read>
  ...
  close(fd);
    ...
    18b3:	e8 94 23 00 00       	call   3c4c <close>
  ...
  for(i = 0; i < 40; i++){
    ...
    1a02:	e8 15 22 00 00       	call   3c1c <exit>
      ...
      wait();
    1a07:	e8 20 22 00 00       	call   3c2c <wait>
  if(n != 40){
    printf(1, "concreate not enough files in directory listing\n");
    exit();
  }
...
linkunlink()
{
  ...
  unlink("x");
    ...
    1a51:	e8 1e 22 00 00       	call   3c74 <unlink>
  pid = fork();
  ...
  for(i = 0; i < 100; i++){
    ...
    1ada:	e8 85 21 00 00       	call   3c64 <open>
    1adf:	89 04 24             	mov    %eax,(%esp)
    1ae2:	e8 65 21 00 00       	call   3c4c <close>
  ...
  if(pid)
    ...
    wait();
    1b3c:	e8 eb 20 00 00       	call   3c2c <wait>
  else 
    exit();
...
bigdir(void)
{
  ...
  close(fd);
    ...
    1bbe:	e8 89 20 00 00       	call   3c4c <close>
  ...
  for(i = 0; i < 500; i++){
    ...
    1c0e:	e8 71 20 00 00       	call   3c84 <link>
  ...
  unlink("bd");
    ...
    1c44:	e8 2b 20 00 00       	call   3c74 <unlink>
  for(i = 0; i < 500; i++){
    ...
    1c8c:	e8 e3 1f 00 00       	call   3c74 <unlink>
...
subdir(void)
{
  ...
  unlink("ff");
    ...
    1cf2:	e8 7d 1f 00 00       	call   3c74 <unlink>
  if(mkdir("dd") != 0){
    1cf7:	c7 04 24 41 4a 00 00 	movl   $0x4a41,(%esp)
    1cfe:	e8 89 1f 00 00       	call   3c8c <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2f:	e8 30 1f 00 00       	call   3c64 <open>
  ...
  write(fd, "ff", 2);
    ...
    1d6c:	e8 d3 1e 00 00       	call   3c44 <write>
  close(fd);
    1d71:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1d74:	89 04 24             	mov    %eax,(%esp)
    1d77:	e8 d0 1e 00 00       	call   3c4c <close>
  
  if(unlink("dd") >= 0){
    1d7c:	c7 04 24 41 4a 00 00 	movl   $0x4a41,(%esp)
    1d83:	e8 ec 1e 00 00       	call   3c74 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 db 1e 00 00       	call   3c8c <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ddd:	e8 82 1e 00 00       	call   3c64 <open>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e76:	e8 c1 1d 00 00       	call   3c3c <read>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1eeb:	e8 84 1d 00 00       	call   3c74 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1f1c:	e8 43 1d 00 00       	call   3c64 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1f45:	e8 4a 1d 00 00       	call   3c94 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1f6e:	e8 21 1d 00 00       	call   3c94 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1f97:	e8 f8 1c 00 00       	call   3c94 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1fc0:	e8 cf 1c 00 00       	call   3c94 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ff1:	e8 6e 1c 00 00       	call   3c64 <open>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    202e:	e8 09 1c 00 00       	call   3c3c <read>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    209c:	e8 c3 1b 00 00       	call   3c64 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    20cd:	e8 92 1b 00 00       	call   3c64 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    20fe:	e8 61 1b 00 00       	call   3c64 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    212f:	e8 30 1b 00 00       	call   3c64 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2160:	e8 ff 1a 00 00       	call   3c64 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2191:	e8 ee 1a 00 00       	call   3c84 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    21c2:	e8 bd 1a 00 00       	call   3c84 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    21f3:	e8 8c 1a 00 00       	call   3c84 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    221c:	e8 6b 1a 00 00       	call   3c8c <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2245:	e8 42 1a 00 00       	call   3c8c <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    226e:	e8 19 1a 00 00       	call   3c8c <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2297:	e8 d8 19 00 00       	call   3c74 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    22c0:	e8 af 19 00 00       	call   3c74 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    22e9:	e8 a6 19 00 00       	call   3c94 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    2312:	e8 7d 19 00 00       	call   3c94 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    233b:	e8 34 19 00 00       	call   3c74 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    2364:	e8 0b 19 00 00       	call   3c74 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    238d:	e8 e2 18 00 00       	call   3c74 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    23b6:	e8 b9 18 00 00       	call   3c74 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    23df:	e8 90 18 00 00       	call   3c74 <unlink>
...
bigwrite(void)
{
  ...
  unlink("bigwrite");
    ...
    2438:	e8 37 18 00 00       	call   3c74 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2458:	e8 07 18 00 00       	call   3c64 <open>
    ...
    249d:	e8 a2 17 00 00       	call   3c44 <write>
    ...
    24e4:	e8 63 17 00 00       	call   3c4c <close>
    unlink("bigwrite");
    24e9:	c7 04 24 8f 4e 00 00 	movl   $0x4e8f,(%esp)
    24f0:	e8 7f 17 00 00       	call   3c74 <unlink>
  int fd, sz;
...
bigfile(void)
{
  ...
  for(i = 0; i < 20; i++){
    ...
    25b5:	e8 8a 16 00 00       	call   3c44 <write>
  ...
  for(i = 0; ; i++){
    ...
    2649:	e8 ee 15 00 00       	call   3c3c <read>
  ...
  close(fd);
    ...
    2701:	e8 46 15 00 00       	call   3c4c <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    272f:	e8 40 15 00 00       	call   3c74 <unlink>
...
fourteen(void)
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    276b:	e8 1c 15 00 00       	call   3c8c <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2794:	e8 f3 14 00 00       	call   3c8c <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27c5:	e8 9a 14 00 00       	call   3c64 <open>
  ...
  close(fd);
    ...
    2833:	e8 14 14 00 00       	call   3c4c <close>

  if(mkdir("12345678901234/12345678901234") == 0){
    2838:	c7 04 24 fa 50 00 00 	movl   $0x50fa,(%esp)
    283f:	e8 48 14 00 00       	call   3c8c <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2868:	e8 1f 14 00 00       	call   3c8c <mkdir>
...
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    ...
    28c1:	e8 c6 13 00 00       	call   3c8c <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    28ea:	e8 a5 13 00 00       	call   3c94 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2913:	e8 5c 13 00 00       	call   3c74 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    293c:	e8 33 13 00 00       	call   3c74 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2965:	e8 2a 13 00 00       	call   3c94 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    298e:	e8 e1 12 00 00       	call   3c74 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    29b7:	e8 b8 12 00 00       	call   3c74 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    29e0:	e8 8f 12 00 00       	call   3c74 <unlink>
...
dirfile(void)
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2a41:	e8 1e 12 00 00       	call   3c64 <open>
  ...
  close(fd);
    ...
    2a6e:	e8 d9 11 00 00       	call   3c4c <close>
  if(chdir("dirfile") == 0){
    2a73:	c7 04 24 76 52 00 00 	movl   $0x5276,(%esp)
    2a7a:	e8 15 12 00 00       	call   3c94 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aab:	e8 b4 11 00 00       	call   3c64 <open>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ae1:	e8 7e 11 00 00       	call   3c64 <open>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2b0f:	e8 78 11 00 00       	call   3c8c <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2b38:	e8 37 11 00 00       	call   3c74 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2b69:	e8 16 11 00 00       	call   3c84 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2b92:	e8 dd 10 00 00       	call   3c74 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2bc3:	e8 9c 10 00 00       	call   3c64 <open>
  ...
  fd = open(".", 0);
    ...
    2bf9:	e8 66 10 00 00       	call   3c64 <open>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c17:	e8 28 10 00 00       	call   3c44 <write>
  ...
  close(fd);
    ...
    2c3f:	e8 08 10 00 00       	call   3c4c <close>
...
iref(void)
{
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2c87:	e8 00 10 00 00       	call   3c8c <mkdir>
    ...
    2cb0:	e8 df 0f 00 00       	call   3c94 <chdir>
    ...
    2d3d:	e8 0a 0f 00 00       	call   3c4c <close>
    unlink("xx");
    2d42:	c7 04 24 d7 53 00 00 	movl   $0x53d7,(%esp)
    2d49:	e8 26 0f 00 00       	call   3c74 <unlink>
  int i, fd;
  ...
  chdir("/");
    ...
    2d63:	e8 2c 0f 00 00       	call   3c94 <chdir>
    ...
    2db5:	e8 62 0e 00 00       	call   3c1c <exit>
{
  ...
  for(; n > 0; n--){
    if(wait() < 0){
    2dec:	e8 3b 0e 00 00       	call   3c2c <wait>
  ...
  if(wait() != -1){
    2e18:	e8 0f 0e 00 00       	call   3c2c <wait>
...
sbrktest(void)
{
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2e9e:	e8 09 0e 00 00       	call   3cac <sbrk>
  ...
  c = sbrk(1);
    ...
    2f28:	e8 7f 0d 00 00       	call   3cac <sbrk>
    2f2d:	89 45 e0             	mov    %eax,-0x20(%ebp)
  c = sbrk(1);
    2f30:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f37:	e8 70 0d 00 00       	call   3cac <sbrk>
  ...
  wait();
    2f6f:	e8 b8 0c 00 00       	call   3c2c <wait>

  // can one grow address space to something big?
#define BIG (100*1024*1024)
  a = sbrk(0);
    2f74:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2f7b:	e8 2c 0d 00 00       	call   3cac <sbrk>
  ...
  p = sbrk(amt);
    ...
    2f9a:	e8 0d 0d 00 00       	call   3cac <sbrk>
  ...
  *lastaddr = 99;
  ...
  c = sbrk(0);
    ...
    3016:	e8 91 0c 00 00       	call   3cac <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3080:	e8 27 0c 00 00       	call   3cac <sbrk>
  ...
  a = sbrk(0);
    ...
    30e5:	e8 c2 0b 00 00       	call   3cac <sbrk>
  ...
  c = sbrk(-(sbrk(0) - oldbrk));
    ...
    3105:	e8 a2 0b 00 00       	call   3cac <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    3146:	e8 59 0b 00 00       	call   3ca4 <getpid>
    ...
    31ab:	e8 a4 0a 00 00       	call   3c54 <kill>
      exit();
    31b0:	e8 67 0a 00 00       	call   3c1c <exit>
    }
    wait();
    31b5:	e8 72 0a 00 00       	call   3c2c <wait>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    exit();
  }
  ...
  if(pipe(fds) != 0){
    ...
    31d4:	e8 5b 0a 00 00       	call   3c34 <pipe>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    321d:	e8 8a 0a 00 00       	call   3cac <sbrk>
    ...
    3230:	e8 77 0a 00 00       	call   3cac <sbrk>
      write(fds[1], "x", 1);
    ...
    324b:	e8 f4 09 00 00       	call   3c44 <write>
      // sit around until killed
      for(;;) sleep(1000);
    3250:	c7 04 24 e8 03 00 00 	movl   $0x3e8,(%esp)
    3257:	e8 58 0a 00 00       	call   3cb4 <sleep>
    ...
    327f:	e8 b8 09 00 00       	call   3c3c <read>
  // failed allocation?
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
    exit();
  ...
  c = sbrk(4096);
    ...
    329b:	e8 0c 0a 00 00       	call   3cac <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    32c2:	e8 8d 09 00 00       	call   3c54 <kill>
    wait();
    32c7:	e8 60 09 00 00       	call   3c2c <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    3302:	e8 a5 09 00 00       	call   3cac <sbrk>
...
validatetest(void)
{
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33b9:	e8 f6 08 00 00       	call   3cb4 <sleep>
    sleep(0);
    33be:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    33c5:	e8 ea 08 00 00       	call   3cb4 <sleep>
    kill(pid);
    33ca:	8b 45 f0             	mov    -0x10(%ebp),%eax
    33cd:	89 04 24             	mov    %eax,(%esp)
    33d0:	e8 7f 08 00 00       	call   3c54 <kill>
    wait();
    33d5:	e8 52 08 00 00       	call   3c2c <wait>
    ...
    33e8:	e8 97 08 00 00       	call   3c84 <link>
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    ...
    34b4:	e8 bb 07 00 00       	call   3c74 <unlink>
  pid = fork();
  ...
  if(pid == 0){
    ...
    351a:	e8 3d 07 00 00       	call   3c5c <exec>
  ...
  close(fd);
    ...
    35bd:	e8 8a 06 00 00       	call   3c4c <close>
  unlink("bigarg-ok");
    35c2:	c7 04 24 63 56 00 00 	movl   $0x5663,(%esp)
    35c9:	e8 a6 06 00 00       	call   3c74 <unlink>
}
    35ce:	c9                   	leave  
    35cf:	c3                   	ret    
...
fsfull()
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36f0:	e8 6f 05 00 00       	call   3c64 <open>
    ...
    3738:	e8 07 05 00 00       	call   3c44 <write>
    ...
    3777:	e8 d0 04 00 00       	call   3c4c <close>
    if(total == 0)
  ...
  while(nfiles >= 0){
    ...
    3866:	e8 09 04 00 00       	call   3c74 <unlink>
    nfiles--;
...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    38de:	e8 81 03 00 00       	call   3c64 <open>
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    390f:	e8 50 03 00 00       	call   3c64 <open>
    3914:	89 04 24             	mov    %eax,(%esp)
    3917:	e8 30 03 00 00       	call   3c4c <close>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    3af2:	e8 45 01 00 00       	call   3c3c <read>
...
stat(char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    3b50:	e8 0f 01 00 00       	call   3c64 <open>
...
00003cc4 <waitpid>:
    3cc4:	b8 18 00 00 00       	mov    $0x18,%eax
    3cc9:	cd 40                	int    $0x40
    3ccb:	c3                   	ret    

00003ccc <wait1>:
    3ccc:	b8 17 00 00 00       	mov    $0x17,%eax
    3cd1:	cd 40                	int    $0x40
    3cd3:	c3                   	ret    
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    3cf5:	e8 4a ff ff ff       	call   3c44 <write>
}
    3cfa:	c9                   	leave  
    3cfb:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    405a:	e8 4d fc ff ff       	call   3cac <sbrk>
