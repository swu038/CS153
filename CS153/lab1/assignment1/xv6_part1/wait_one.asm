...
int main(int argc, char ** argv){
 ...
 11b:	e8 d4 03 00 00       	call   4f4 <waitpid>
 ...
 15f:	e8 f0 02 00 00       	call   454 <exit1>
            }
            exit1(0);
 164:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 16b:	e8 e4 02 00 00       	call   454 <exit1>
        }
    }else if(pid == 0){
 ...
 19a:	e8 b5 02 00 00       	call   454 <exit1>
    }
    int going = 1;
 ...
 1b0:	e8 47 03 00 00       	call   4fc <wait1>
 ...
 1e3:	e8 6c 02 00 00       	call   454 <exit1>
