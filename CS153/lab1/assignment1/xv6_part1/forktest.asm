  ...
  60:	e8 13 03 00 00       	call   378 <exit>
{
  ...
  for(; n > 0; n--){
    if(wait() < 0){
  9f:	e8 e4 02 00 00       	call   388 <wait>
  ...
  if(wait() != -1){
  cb:	e8 b8 02 00 00       	call   388 <wait>
...
gets(char *buf, int max)
{
 ...
 24e:	e8 45 01 00 00       	call   398 <read>
...
stat(char *n, struct stat *st)
{
 ...
 2ac:	e8 0f 01 00 00       	call   3c0 <open>
