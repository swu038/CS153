...
grep(char *pattern, int fd)
{
  ...
  66:	e8 71 05 00 00       	call   5dc <write>
      }
      p = q+1;
  ...
  cc:	e8 9d 04 00 00       	call   56e <memmove>
{
  ...
  f6:	e8 d9 04 00 00       	call   5d4 <read>
...
main(int argc, char *argv[])
{
 ...
 17e:	e8 79 04 00 00       	call   5fc <open>
 ...
 1d2:	e8 0d 04 00 00       	call   5e4 <close>
  if(argc <= 2){
    grep(pattern, 0);
    exit();
  }
...
gets(char *buf, int max)
{
 ...
 48a:	e8 45 01 00 00       	call   5d4 <read>
...
stat(char *n, struct stat *st)
{
 ...
 4e8:	e8 0f 01 00 00       	call   5fc <open>
...
morecore(uint nu)
{
 ...
 9f2:	e8 4d fc ff ff       	call   644 <sbrk>
