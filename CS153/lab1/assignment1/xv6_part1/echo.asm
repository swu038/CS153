...
gets(char *buf, int max)
{
 ...
 1a2:	e8 45 01 00 00       	call   2ec <read>
...
stat(char *n, struct stat *st)
{
 ...
 200:	e8 0f 01 00 00       	call   314 <open>
...
morecore(uint nu)
{
 ...
 70a:	e8 4d fc ff ff       	call   35c <sbrk>
