...
int main(int argc, char ** argv){
  ...
  9e:	c7 04 24 32 00 00 00 	movl   $0x32,(%esp)
 ...
 11b:	e8 50 04 00 00       	call   570 <waitpid>
 ...
 194:	e8 d7 03 00 00       	call   570 <waitpid>
 ...
 1da:	e8 f1 02 00 00       	call   4d0 <exit1>
            exit1(0);
 1df:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 1e6:	e8 e5 02 00 00       	call   4d0 <exit1>
        }
    }else if(pid == 0){
 ...
 215:	e8 b6 02 00 00       	call   4d0 <exit1>
    }
    int going = 1;
 ...
 22b:	e8 48 03 00 00       	call   578 <wait1>
 ...
 25e:	e8 6d 02 00 00       	call   4d0 <exit1>
 263:	90                   	nop
...
000004d8 <wait>:
 4d8:	b8 03 00 00 00       	mov    $0x3,%eax
 4dd:	cd 40                	int    $0x40
 4df:	c3                   	ret    
